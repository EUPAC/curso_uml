...
import com.sisger.cursomc.domain.Produto;
import com.sisger.cursomc.repositories.CategoriaRepository;
import com.sisger.cursomc.repositories.ProdutoRepository;
...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		produtoRepository.saveAll(Arrays.asList(p1, p2, p2));
